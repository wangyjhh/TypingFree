...
<template>
    <div w="100%" h="100%" p-20px>
        <input
            ...
            :value="inputValue" @keyup="onKeyUp($event)" @keydown="onKeyDown($event)"
        >
        ...
        <div
            h-full bg="#1b1b1b" b-rd="24px" mb="12px" flex="~ 1 1 0%" flex-wrap flex-justify-start pt35 pb20 px10 gap5
            row-gap="30px" @click="onClick"
        >
            <div
                h-full bg="#1b1b1b" mb="12px" flex="~ 1 1 0%" flex-wrap flex-justify-start gap10 row-gap="30px"
